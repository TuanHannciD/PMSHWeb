...
namespace Report.Controllers
{
    public class ReportController : Controller
    {
        ...
        //    DataTable dataTable = GuestMarketReportBO.GuestMarketReport(fromDate, toDate, currency, zonecode);
        ...
        //        DataTable dataTable = RateCodeBO.RatecodebyDate(fromDate, toDate, ratecode);
        ...
        //    try
        //    {
        //        DataTable dataTable = ReportNationalityStatisticsBO.ReportNationalityStatistics(fromDate, toDate, status, sortOder);
        //        var result = (from d in dataTable.AsEnumerable()
        //                      select new
        //                      {
        ...
        //    try
        //    {
        //        DataTable dataTable = ReservationSummaryReportBO.ReservationSummaryReport(fromDate, toDate);
        //        var result = (from d in dataTable.AsEnumerable()
        //                      select new
        //                      {
        ...
        //    try
        //    {
        //        DataTable dataTable = GroupReservationReportBO.GroupReservation(fromDate, toDate, noofRoom);
        //        var result = (from d in dataTable.AsEnumerable()
        //                      select new
        //                      {
        ...
        //    try
        //    {
        //        DataTable dataTable = GuestStayOverReportBO.GuestStayOver(fromDate, toDate);
        //        var result = (from d in dataTable.AsEnumerable()
        //                      select new
        //                      {
        //                          ConfirmationNo = !string.IsNullOrEmpty(d["ConfirmationNo"].ToString()) ? d["ConfirmationNo"] : "",
        ...
        //    try
        //    {
        //        DataTable dataTable = GuestStayReportBO.GuestStay(noofName, stayno, stayand);
        //        var result = (from d in dataTable.AsEnumerable()
        //                      select new
        //                      {
        //                          Code = !string.IsNullOrEmpty(d["Code"].ToString()) ? d["Code"] : "",
        ...
        //    DataTable dataTable = TraceReportBO.TraceReportView(fromDate, toDate, roomClass, department, status, byAlphabetical, byRoom, byVip, pseudoRoom, reserved, checkedIn, dueout, individual, blockcode, vipOnly);
